...
class StorageServ{
  ...
  static Box<T> getBox<T>(StorageType type) => Hive.box<T>(type.name);
  ...
  static Future<void> init() async {
    ...
    //   ..registerAdapter(SessionAdapter())
    //   ..registerAdapter(ExerciseAdapter())
    //   ..registerAdapter(SetInfoAdapter())
    //   ..registerAdapter(RoutineAdapter())
    //   ..registerAdapter(ExerciseBestSetAdapter());
    ...
    await Hive.openBox<String>(StorageType.auth.name, encryptionCipher: HiveAesCipher(base64Url.decode(ekey)));
    await Hive.openBox<int>(StorageType.tasks.name);
